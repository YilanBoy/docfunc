...
/*!**********************************************!*\
  !*** ./resources/js/scroll-to-bottom-btn.js ***!
  \**********************************************/
// Get the button
var scrollToBottomButton = document.getElementById('scroll-to-bottom-btn');
scrollToBottomButton.addEventListener('click', scrollToBottom); // When the user clicks on the button, scroll to the bottom

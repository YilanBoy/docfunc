...
>
  ...
  <div class="flex justify-between mt-6">
    ...
    >
      <span
        class="absolute inset-0 inline-flex items-center self-stretch justify-center px-6 font-medium text-center transition-transform bg-blue-600 rounded-lg text-gray-50 ring-1 ring-blue-600 ring-offset-1 ring-offset-blue-600 group-hover:-translate-y-2 group-hover:-translate-x-2"
      >

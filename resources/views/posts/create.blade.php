        ...
        <div class="min-h-screen flex justify-center items-start px-4 xl:px-0 mt-6">
            ...
            <div class="w-full xl:w-2/3 space-y-6 flex flex-col justify-center items-center">
                ...
                <x-card class="relative w-full">
                    ...
                    <div
                        class="hidden xl:block absolute top-0 left-[102%] w-52 h-full"
                    >
                        <div class="sticky top-9 flex flex-col">
                            ...
                            <button
                                ...
                                class="save-post group w-16 h-16 mt-4 inline-flex justify-center items-center border border-transparent rounded-xl text-gray-50
                    ...
                    <form id="create-post" action="{{ route('posts.store') }}" method="POST">
                        ...
                        <div>
                            ...
                            <input
                                type="text" id="title" name="title" placeholder="文章標題" value="{{ old('title') }}"
                                required
                                autofocus
                        ...
                        <div class="mt-5">
                            ...
                            >
                                <option value="" hidden disabled {{ old('category_id') ? '' : 'selected' }}>請選擇分類
                                </option>
                        ...
                        {{-- 文章內容 --}}
                        <div class="blog-post max-w-none mt-5">

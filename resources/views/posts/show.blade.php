        ...
        <x-card class="relative w-full xl:w-2/3">
            ...
            <div class="sticky flex flex-col items-center justify-center top-7">
              @if (auth()->id() === $post->user_id)
                ...
                <a
                  ...
                  class="inline-flex items-center justify-center w-16 h-16 transition duration-150 ease-in-out bg-green-500 border border-transparent group rounded-xl text-gray-50 hover:bg-green-600 active:bg-green-700 focus:outline-none focus:border-green-700 focus:ring ring-green-300"
                >
          ...
          @if ($post->tags()->exists())
            <div class="flex items-center mt-4">
              <span class="mr-1 text-zinc-400"><i class="bi bi-tags-fill"></i></span>
